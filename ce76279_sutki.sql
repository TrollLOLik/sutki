...
--
-- Хост: localhost
-- Время создания: Июн 11 2026 г., 12:53
...
--
-- База данных: `ce76279_sutki`
--

-- --------------------------------------------------------

--
-- Структура таблицы `admin_story`
--
...
CREATE TABLE IF NOT EXISTS `admin_story` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_4B7CFFC2642B8210` (`admin_id`),
  KEY `IDX_4B7CFFC212469DE2` (`category_id`),
  KEY `IDX_4B7CFFC2ED5CA9E6` (`service_id`),
  KEY `IDX_4B7CFFC2A76ED395` (`user_id`)
...
CREATE TABLE IF NOT EXISTS `comment` (
  ...
  KEY `IDX_9474526C6BB74515` (`house_id`),
  KEY `IDX_9474526C727ACA70` (`parent_id`),
  KEY `IDX_9474526C2261B4C3` (`addressee_id`)
...
CREATE TABLE IF NOT EXISTS `file` (
  ...
  `path` varchar(1200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `deleted` tinyint(1) NOT NULL,
  `position` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_8C9F36106BB74515` (`house_id`)
...
(68, 29, '1755474701_4b15bab375019b898006ce918751e493.png', NULL, 'png', NULL, '../upload_files/1755474701_4b15bab375019b898006ce918751e493.png', 0, 1, '2025-08-18 04:51:41', '2025-08-18 04:51:41'),
(69, 30, '1755708317_52fa13fc8c88e588a060a110661ae95c.jpg', NULL, 'jpg', NULL, '../upload_files/1755708317_52fa13fc8c88e588a060a110661ae95c.jpg', 0, 1, '2025-08-20 21:45:17', '2025-08-20 21:45:17'),
(70, 31, '1756114485_7405f47c7b9457e2d0b4a82afa4d1304.jpg', NULL, 'jpg', NULL, '../upload_files/1756114485_7405f47c7b9457e2d0b4a82afa4d1304.jpg', 0, 1, '2025-08-25 14:34:45', '2025-08-25 14:34:45'),
(71, 32, '1756114488_9ada9b0da0d27c984b105adf9877b784.jpg', NULL, 'jpg', NULL, '../upload_files/1756114488_9ada9b0da0d27c984b105adf9877b784.jpg', 0, 1, '2025-08-25 14:34:48', '2025-08-25 14:34:48'),
(72, 33, '1756116881_3e59750432483f5edf40c3cb3cf72e02.PNG', NULL, 'jpg', NULL, '../upload_files/1756116881_3e59750432483f5edf40c3cb3cf72e02.PNG', 0, 1, '2025-08-25 15:14:41', '2025-08-25 15:14:41'),
(74, 35, '1758116604_eb3ecfe474f5b5bfb78949b42f0314b2.jpg', NULL, 'jpg', NULL, '../upload_files/1758116604_eb3ecfe474f5b5bfb78949b42f0314b2.jpg', 0, 2, '2025-09-17 18:43:24', '2025-09-17 18:43:24'),
(75, 34, '1760608210_30040b86f38263abbaa84e8c462c6df7.jpg', NULL, 'jpg', NULL, '../upload_files/1760608210_30040b86f38263abbaa84e8c462c6df7.jpg', 0, 1, '2025-10-16 14:50:10', '2025-10-16 14:50:10');
...
CREATE TABLE IF NOT EXISTS `house` (
  ...
  `description` varchar(5005) COLLATE utf8mb4_unicode_ci NOT NULL,
  `price` int(11) NOT NULL,
  `deleted` tinyint(1) NOT NULL,
  `count_room` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'new',
  `country` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Магнитогорск',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `views` int(11) NOT NULL DEFAULT '0',
  `last_date_view` datetime DEFAULT NULL,
  `views_current_day` int(11) DEFAULT NULL,
  `date_top` datetime DEFAULT NULL,
  `pay` tinyint(1) NOT NULL DEFAULT '0',
  `house_number` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `area` int(11) NOT NULL,
  `number_room` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rejection_reason` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_67D5399D7E3C61F9` (`owner_id`)
...
(29, 2, 'Коробова', '132', 132, 1, '1', 'new', 'Магнитогорск', '2025-08-18 04:51:41', '2025-10-01 21:43:11', 15, '2025-09-19 13:42:47', 1, '2025-08-25 15:11:24', 1, '12', 12, '2', NULL),
(30, 2, 'Коробова', '132', 123, 0, '2', 'active', 'Магнитогорск', '2025-08-20 21:45:17', '2026-04-28 12:45:14', 21, '2026-04-28 12:45:14', 1, '2025-08-25 15:12:42', 1, '12', 12, '', NULL),
(31, 2, 'Коробова', '123', 2222, 0, '2', 'cancel', 'Магнитогорск', '2025-08-25 14:34:45', '2025-09-17 19:08:16', 9, '2025-09-17 19:08:16', 1, '2025-08-25 14:59:10', 1, '12', 213, '12', NULL),
(32, 2, 'Коробова', '123', 2222, 0, '2', 'cancel', 'Магнитогорск', '2025-08-25 14:34:48', '2025-09-14 14:20:38', 9, '2025-09-12 03:42:11', 1, '2025-08-25 15:12:05', 1, '12', 213, '12', NULL),
(33, 2, 'Коробова ', '5', 1000, 0, '5', 'cancel', 'Магнитогорск', '2025-08-25 15:14:41', '2025-09-18 10:06:23', 6, '2025-09-18 10:06:20', 1, NULL, 0, '12', 5, '138', NULL),
(34, 20, 'Коробова ', 'Уточните, пожалуйста, ваш запрос. Что нужно сделать?', 1000, 0, '3', 'new', 'Магнитогорск', '2025-09-07 13:55:11', '2025-10-16 14:51:00', 13, '2025-10-16 14:50:11', 1, '2025-10-16 14:50:36', 1, '12', 100, '131', NULL),
(35, 20, 'Коробова ', 'щущк', 1000, 0, '3', 'cancel', 'Магнитогорск', '2025-09-17 18:43:24', '2025-10-01 21:45:34', 2, '2025-10-01 21:45:24', 1, '2025-10-01 21:45:15', 1, '12', 100, '131', NULL);

-- --------------------------------------------------------

--
-- Структура таблицы `house_category`
--
...
--
-- Дамп данных таблицы `house_category`
--

INSERT INTO `house_category` (`id`, `name`, `deleted`, `created_at`, `updated_at`) VALUES
(1, 'Квартиры', 0, '2024-05-25 01:53:09', '2024-05-25 01:53:23'),
(2, 'Однокомнатная', 0, '2025-05-04 03:41:45', '2025-05-04 03:41:45'),
(3, 'Многокомнатная', 0, '2025-05-04 04:07:35', '2025-05-04 04:07:35'),
(4, 'Коттедж ', 0, '2025-09-07 13:56:48', '2025-09-07 13:56:58');

-- --------------------------------------------------------

--
-- Структура таблицы `house_house_category`
--
...
CREATE TABLE IF NOT EXISTS `house_house_category` (
  ...
  KEY `IDX_A2C97DEF6BB74515` (`house_id`),
  KEY `IDX_A2C97DEF6C967117` (`house_category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `house_house_category`
--
...
--
-- Структура таблицы `house_house_service`
--
...
CREATE TABLE IF NOT EXISTS `house_house_service` (
  ...
  KEY `IDX_B53DD9B46BB74515` (`house_id`),
  KEY `IDX_B53DD9B4ED5CA9E6` (`service_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `house_house_service`
--
...
CREATE TABLE IF NOT EXISTS `request` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_3B978F9F6BB74515` (`house_id`),
...
--
-- Структура таблицы `request_viewers`
--
...
CREATE TABLE IF NOT EXISTS `request_viewers` (
  ...
  `guest_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_2A28448B427EB8A5` (`request_id`),
  KEY `IDX_2A28448BA76ED395` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `request_viewers`
--
...
CREATE TABLE IF NOT EXISTS `review` (
  ...
  `rejection_reason` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_794381C67E3C61F9` (`owner_id`),
  KEY `IDX_794381C66BB74515` (`house_id`)
...
(1, 'Холодильник', 0, '2024-05-25 01:45:45', '2024-05-25 01:45:45'),
(2, 'Wi fi', 0, '2024-06-30 21:02:29', '2024-06-30 21:02:29'),
(3, 'Посуда', 0, '2024-06-30 21:02:36', '2024-06-30 21:02:36'),
(5, 'Гриль', 0, '2025-04-12 18:23:42', '2025-04-12 18:23:42'),
(6, 'Микроволновая печь', 0, '2025-04-12 18:23:42', '2025-04-12 18:23:42'),
(7, 'ТВ приставка', 0, '2025-04-12 18:23:42', '2025-04-12 18:23:42'),
(8, 'Душевая кабина', 0, '2025-04-12 18:23:42', '2025-04-12 18:23:42'),
(9, 'Посуда', 0, '2025-04-12 18:23:42', '2025-04-12 18:23:42'),
(10, 'Play Station', 1, '2025-05-04 03:42:11', '2025-05-04 03:42:18');

-- --------------------------------------------------------

--
-- Структура таблицы `session_ip_address`
--
...
(2, 'Adidasik', '147', NULL, 'artuom2021@gmail.com', '$2y$13$EdzkJQ4n52bdEnj9pjxvDOPuMz0W3mR/WicTVqxupvoIZ.k99qlMO', '[\"ROLE_ADMIN\"]', 0, 0, '100024804929215482852', NULL, NULL, 'Магнитогорск', 1, '2024-05-21 20:27:05', '2025-10-17 00:32:03', '662007', '2025-10-17 00:32:00', NULL),
(3, 'Юлия', NULL, NULL, 'mlpokn1980@yandex.ru', '$2y$13$M52EkwBPXAJiB6sFIKC9WuqfjBXCz5JIvZ2dzK6elFQvi4DG.ddxO', '[\"ROLE_ADMIN\", \"ROLE_USER\"]', 0, 0, NULL, NULL, NULL, 'Магнитогорск', 1, '2024-05-21 21:08:03', '2024-05-26 16:37:34', NULL, NULL, NULL),
(4, 'Анастасия ', NULL, NULL, 'anastasia9', '$2y$13$2uxVtfLc93j37NIGMlj3ROYoGP5mh0YnYKbcWDX2UYs/r1veBNqhK', '[\"ROLE_USER\"]', 0, 0, NULL, NULL, NULL, NULL, 1, '2024-05-21 22:59:25', '2024-05-21 22:59:25', NULL, NULL, NULL),
(5, 'Александр', NULL, NULL, 'ctb-lider@yandex.ru', '$2y$13$nHbGDGwGa.9a1F19eOzfqe0osDVqW6HxFYuhwZ.XmJMhGOa2sbFMi', '[\"ROLE_ADMIN\", \"ROLE_USER\"]', 0, 0, NULL, NULL, NULL, NULL, 1, '2024-05-22 10:34:59', '2025-08-08 18:14:06', NULL, NULL, NULL),
(6, 'Владимир', NULL, NULL, 'asdccjcn@yandex.ru', '$2y$13$6TNuk/ys1zut46c.pCFin.OGKZukVTysYX8Qp.XlfY8u5O/gi8mXm', '[\"ROLE_USER\"]', 0, 0, NULL, NULL, NULL, NULL, 1, '2024-05-27 10:31:50', '2024-05-27 10:31:50', NULL, NULL, NULL),
(7, 'Анастасия ', NULL, NULL, 'g-nasika2487@mail.ru', '$2y$13$24ZNlttjGcg4ztiG13aTJOtjKW7XjA/gsXi4XhcBpWOLw823oFrqy', '[\"ROLE_USER\"]', 0, 0, NULL, NULL, NULL, 'Санкт-Петербург', 1, '2024-06-05 00:45:10', '2024-06-05 00:45:16', NULL, NULL, NULL),
(8, 'Юлия', 'Панурко', 'Михайловна', 'panurko.yulia@mail.ru', '$2y$13$wIJNpH2wTDVJiVbEVwymNeBVm7D2GjzJ6ZW2iGsejKbGZP8rqLRy2', '[\"ROLE_ADMIN\", \"ROLE_USER\"]', 0, 0, NULL, '+7 (922) 722-97-03', NULL, 'Магнитогорск', 1, '2024-06-10 06:15:58', '2025-09-09 09:11:07', NULL, NULL, NULL),
(9, 'sutkiTest', NULL, NULL, 'sutkiTest@gmail.com', '$2y$13$Y3NXgH.7OKYBW4HQx4DsaOb91Dj05MmtJ0fxTp5vqCMSEStw92B3m', '[\"ROLE_USER\"]', 0, 0, NULL, NULL, NULL, 'Магнитогорск', 1, '2024-06-11 17:50:47', '2024-06-11 17:50:51', NULL, NULL, NULL),
(12, 'Александр', NULL, NULL, '79512603671@yandex.ru', '$2y$13$dzjvdALVXvjoCww7bYh0LOjdWroumCWKBt4hxoWLrsgq3UaR4ktTC', '[\"ROLE_USER\"]', 0, 0, NULL, NULL, NULL, NULL, 1, '2024-06-26 15:24:22', '2024-06-26 15:24:22', NULL, NULL, NULL),
(13, 'Владислав', 'Шерстяных', 'Игоревич', 'vdcjeqjladmh@bk.ru', '$2y$13$fd0Cu9m4OaUG36.ujACGc.6zlVzH1XQgBVkOztMRw/5H7kB31.S6C', '[\"ROLE_USER\"]', 0, 0, NULL, '+7 (900) 299-82-71', NULL, NULL, 1, '2024-07-02 17:11:17', '2024-07-02 17:44:25', NULL, NULL, NULL),
(20, 'Артем ', 'Кочетков', NULL, 'artuom2019@gmail.com', '$2y$13$t/vpawQUDrGyLZdMMUXhyuJmlKvwUMpgByBSKlNfh9dSKP6GQ1Tiq', '[\"ROLE_USER\"]', 0, 0, '117947775982133317577', '78982322505', NULL, NULL, 1, '2024-07-13 00:11:24', '2025-08-05 20:27:39', NULL, NULL, NULL),
(21, 'Артём ', 'Кочетков', 'Евгеньевич ', 'artuom2019@mail.ru', '$2y$13$YoumzRrBTgpfHcyjk6pJqeEZUejgNgxVTvmWJHUZSm2ioY5IW1.Q2', '[\"ROLE_USER\"]', 0, 0, NULL, '+7 (982) 283-84-32', NULL, NULL, 1, '2024-07-13 00:22:26', '2024-07-13 00:49:42', NULL, NULL, NULL),
(22, 'Юля', 'Петрова', NULL, 'yulswb@gmail.com', NULL, '[\"ROLE_USER\"]', 0, 0, '116484124654457798711', NULL, NULL, NULL, 1, '2024-07-24 16:24:05', '2024-07-24 16:24:05', NULL, NULL, NULL),
(25, 'Кетчуп', 'Кетчуп', NULL, 'sane23222@gmail.com', '$2y$13$E3KL8h7seYgo.9myCK4jFeRQH62HvJ15ieIEYKRgD96IeTtLiPKSm', '[\"ROLE_USER\"]', 0, 0, '104960285566747349304', '78574836543', NULL, NULL, 1, '2025-06-21 17:33:50', '2025-06-21 23:10:44', NULL, NULL, NULL),
(26, 'WeebWebWorks', NULL, NULL, 'weebwebworks@gmail.com', NULL, '[\"ROLE_USER\"]', 0, 0, '103985865782414268481', NULL, NULL, NULL, 1, '2025-06-21 17:38:00', '2025-06-21 17:38:00', NULL, NULL, NULL),
(27, 'Александр', 'Темников', 'Павлович', 'alexandr.temnickov@yandex.ru', '$2y$13$WMhEFPpjFIWOy9KBNjpLMOFaYmr8ILMXhvfwsc2rNQj7JCCHQB1mS', '[\"ROLE_USER\"]', 0, 0, NULL, '75435454354', NULL, NULL, 1, '2025-08-12 11:43:39', '2025-08-12 11:55:42', NULL, NULL, NULL),
(28, 'Юлия', NULL, NULL, 'p.panurko@ya.ru', '$2y$13$1xqluKZc/Wg6mPE9.CvN6eBBCSZzxzzDhltJ1/rcH3zjL75GTQEFu', '[\"ROLE_ADMIN\", \"ROLE_USER\"]', 0, 0, NULL, NULL, NULL, NULL, 1, '2025-09-09 08:56:27', '2025-09-09 09:10:42', NULL, NULL, NULL),
(29, 'Nam', 'Phu', NULL, 'phunam279@gmail.com', NULL, '[\"ROLE_USER\"]', 0, 0, '100769121303338494421', NULL, NULL, NULL, 1, '2025-12-17 21:27:24', '2025-12-17 21:27:24', NULL, NULL, NULL),
(30, 'Дмитрий', NULL, NULL, 'elec-list@yandex.ru', '$2y$13$mdPiz5Im79urH5bprixUTuHvPFTPWZPzmIpchqIpwybOMGjO4bw8.', '[\"ROLE_USER\"]', 0, 0, NULL, NULL, NULL, NULL, 1, '2026-01-07 12:09:20', '2026-01-07 12:09:20', NULL, NULL, NULL);
...
--
-- Ограничения внешнего ключа таблицы `admin_story`
--
ALTER TABLE `admin_story`
  ADD CONSTRAINT `FK_4B7CFFC212469DE2` FOREIGN KEY (`category_id`) REFERENCES `house_category` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_4B7CFFC2642B8210` FOREIGN KEY (`admin_id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_4B7CFFC2A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_4B7CFFC2ED5CA9E6` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`) ON DELETE CASCADE;

--
-- Ограничения внешнего ключа таблицы `comment`
--
ALTER TABLE `comment`
  ADD CONSTRAINT `FK_9474526C2261B4C3` FOREIGN KEY (`addressee_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FK_9474526C6BB74515` FOREIGN KEY (`house_id`) REFERENCES `house` (`id`),
...
--
ALTER TABLE `file`
  ADD CONSTRAINT `FK_8C9F36106BB74515` FOREIGN KEY (`house_id`) REFERENCES `house` (`id`);

--
-- Ограничения внешнего ключа таблицы `house`
--
ALTER TABLE `house`
  ADD CONSTRAINT `FK_67D5399D7E3C61F9` FOREIGN KEY (`owner_id`) REFERENCES `user` (`id`);

--
-- Ограничения внешнего ключа таблицы `house_house_category`
--
ALTER TABLE `house_house_category`
  ADD CONSTRAINT `FK_A2C97DEF6BB74515` FOREIGN KEY (`house_id`) REFERENCES `house` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_A2C97DEF6C967117` FOREIGN KEY (`house_category_id`) REFERENCES `house_category` (`id`) ON DELETE CASCADE;

--
-- Ограничения внешнего ключа таблицы `house_house_service`
--
ALTER TABLE `house_house_service`
  ADD CONSTRAINT `FK_B53DD9B46BB74515` FOREIGN KEY (`house_id`) REFERENCES `house` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_B53DD9B4ED5CA9E6` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`) ON DELETE CASCADE;

--
-- Ограничения внешнего ключа таблицы `request`
--
ALTER TABLE `request`
  ADD CONSTRAINT `FK_3B978F9F6BB74515` FOREIGN KEY (`house_id`) REFERENCES `house` (`id`),
  ADD CONSTRAINT `FK_3B978F9FA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Ограничения внешнего ключа таблицы `request_viewers`
--
ALTER TABLE `request_viewers`
  ADD CONSTRAINT `FK_2A28448B427EB8A5` FOREIGN KEY (`request_id`) REFERENCES `request` (`id`),
  ADD CONSTRAINT `FK_2A28448BA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Ограничения внешнего ключа таблицы `review`
--
ALTER TABLE `review`
  ADD CONSTRAINT `FK_794381C66BB74515` FOREIGN KEY (`house_id`) REFERENCES `house` (`id`),
  ADD CONSTRAINT `FK_794381C67E3C61F9` FOREIGN KEY (`owner_id`) REFERENCES `user` (`id`);
